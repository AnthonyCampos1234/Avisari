      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6"> {/* Increased max-width */}
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-12 text-center md:pb-16">
            <h1
              className="mb-6 border-y text-5xl font-bold [border-image:linear-gradient(to_right,transparent,theme(colors.blue.500/.8),transparent)1] md:text-6xl"
              data-aos="zoom-y-out"
              data-aos-delay={150}
            >
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className="relative before:absolute before:inset-0 before:border-y before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1]">
                ...
                >
                  <a
                    className="btn group mb-4 w-full bg-gradient-to-t from-blue-700 to-blue-500 bg-[length:100%_100%] bg-[bottom] text-white shadow hover:bg-[length:100%_150%] sm:mb-0 sm:w-auto"
                    href="#0"
                  >
                  ...
                  <a
                    className="btn w-full bg-white text-blue-800 shadow hover:bg-gray-50 sm:ml-4 sm:w-auto"
                    href="#0"
                  >
                    Learn More
                  </a>

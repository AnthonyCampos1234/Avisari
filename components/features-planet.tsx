        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-gray-900 before:to-gray-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.gray.500),transparent)]">
                <Image
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    <Image
                      className="absolute -left-25 top-16 z-10 animate-[float_4s_ease-in-out_infinite_both] opacity-90 transition-opacity duration-500"
                    ...
                    />
                    <Image
                      className="absolute -left-24 bottom-24 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-90 transition-opacity duration-500"
                    ...
                    />
                    <Image
                      className="absolute bottom-32 left-58 z-10 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-90 transition-opacity duration-500"
                      src={MIT_logo}
                      width={170}
                      height={44}
                      alt="Tag 04"
